...
const CreateScrimCoinflip = (props) => {
    ...
    useEffect(() => {
        ...
        const caller =
            captains[Math.round(Math.random() * 100) % captains.length];
        setCaller(caller);
    }, [
        props.members,
        props.draftFirst,
    ...
    const handleFlip = () => {
        ...
        const nextCaptain =
            captains[
                (captains.findIndex((captain) => captain.id === caller.id) +
                    1) %
                    captains.length
            ];
    ...
    const handleSubmit = () => {
        ...
        setResultMessage(
            `${
                ...
                `${
                    captains.find((c) => c.id === sideFirst).summoner.name
                } will be on ${sideSelection === 0 ? "Team 1" : "Team 2"}.`
        );
